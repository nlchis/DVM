...
│                                                            │
│ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐         │
│ │ Tổng số đơn  │ │ Đang Giao    │ │ Hoàn/Thất Bại│         │
│ │     145      │ │     32       │ │       5      │         │
│ └──────────────┘ └──────────────┘ └──────────────┘         │
│                                                            │
...
**UI-Rules & Đề xuất UX:**
- **Thẻ Thống kê:** Hiển thị màu sắc tương ứng (Xanh lá = Thành công, Vàng = Đang giao, Đỏ = Thất bại/Hoàn hàng). Click vào thẻ sẽ điều hướng tới trang Danh sách Đơn hàng với filter tương ứng được tự động áp dụng.
